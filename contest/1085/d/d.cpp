...
int main()
{
    ...
    //cin>>t;
    while(t--){
        ll n,s; cin>>n>>s; vector<vll> adj(n,vll());
        ll u,v;
        vll deg(n,0);
        forn(i,n-1){
            cin>>u>>v;u--;v--;
        ...
        cout<<fixed<<setprecision(18)<<setfill('0');
        cout<<static_cast<long double>(2*s)/static_cast<long double>(count)<<"\n";
