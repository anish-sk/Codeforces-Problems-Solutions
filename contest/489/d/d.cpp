...
void dfsvisit(vector<vll> &adj,vll &visited, int v, int u){
    visited[v]=1;
    //cout<<u<<" "<<v<<"\n";
    for(auto i: adj[v]){
        //if(u!=-1){
...
int main()
{
    ...
    while(t--){
        ...
        ll n,m; cin>>n>>m; vector<vll> adj(n,vll()); ll u,v;
        forn(i,m){
            cin>>u>>v;u--;v--;
            adj[u].pb(v); 
        }
