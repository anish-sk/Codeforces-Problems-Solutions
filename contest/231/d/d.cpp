...
int main()
{
    ...
    //cin>>t;
    while(t--){
        int x,y,z,x1,y1,z1; vi a(6);cin>>x>>y>>z>>x1>>y1>>z1; cin>>a;
        ll s = 0;
        //if(y>y1 && x>=0 && x<=x1 && z>=0 && z<=z1) s=a[1];
        //else if(y<0 && x>=0 && x<=x1 && z>=0 && z<=z1) s=a[0];
        //else if(x>x1 && y>=0 && y<=y1 && z>=0 && z<=z1) s= a[5];
        //else if(x<0 && y>=0 && y<=y1 && z>=0 && z<=z1) s= a[4];
        //else if(z>z1 && y>=0 && y<=y1 && x>=0 && x<=x1) s= a[3];
        //else if(z<0 && y>=0 && y<=y1 && x>=0 && x<=x1) s= a[2];
        //else if(y>y1 && x<0 && z>=0 && z<=z1) s=a[1]+a[4];
        if(y>y1) s+=a[1];
        else if(y<0) s+=a[0];
        if(z>z1) s+=a[3];
        else if(z<0) s+=a[2];
