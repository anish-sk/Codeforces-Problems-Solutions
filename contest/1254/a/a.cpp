...
int main()
{
    ...
    cin>>t;
    while(t--){
        ll r,c,k; cin>>r>>c>>k; vector<string> a(r, ""); forn(i,r) cin>>a[i];
        vector<string> ans(r, string(c, '0')); ll total = 0;
        for(auto s: a) for(auto i : s) if(i == 'R') total ++;
        //cout<<total<<"\n";
        ll large = total - (total/k)*k;
        ll small = k - large;
        //cout<<large<<" "<<small<<"\n";
        ll gif  = total/k;
        ll scf = ceil(total, k);
        ...
        for(int i=0; i<r; i++){
            ...
            //cout<<curr<<"$"<<cr<<"^";
                    ...
                    if(a[i][j] == 'R'){
                        cr++;
                        if(curr < small and cr == gif){
                            cr = 0;
                            curr++;
                        }
                        else if(curr >=small and cr == scf){
                            cr=0;
                            curr++;
                        }
                        //else{
