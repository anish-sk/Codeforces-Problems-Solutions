...
int main(){
    ...
    while(t--){
        ll n,k; cin>>n>>k;
        vector<vector<vector<ll>>> dp(n+5,vector<vector<ll>>(2*n+5,vll(4,0)));
        dp[1][1][0]=1;dp[1][1][1]=0;dp[1][1][2]=0;dp[1][1][3]=1;
        dp[1][2][0]=0;dp[1][2][1]=1;dp[1][2][2]=1;dp[1][2][3]=0;
        for(int i=2;i<=n;i++){
            dp[i][2*i][0]=0;
            dp[i][2*i][3]=0;
            dp[i][2*i][1]=1;
        ...
        for(int i=2;i<=n;i++){
            for(int j=2;j<=2*i-1;j++){
                ...
                dp[i][j][3]=(dp[i-1][j][3]+dp[i-1][j][1]+dp[i-1][j][2]+dp[i-1][j-1][0])%p;
                dp[i][j][1]=(dp[i-1][j-1][0]+dp[i-1][j-1][3]+dp[i-1][j][1]+dp[i-1][j-2][2])%p;
                dp[i][j][2]=(dp[i-1][j-1][0]+dp[i-1][j-1][3]+dp[i-1][j][2]+dp[i-1][j-2][1])%p;
            }
        }
        //for(int i=1;i<=n;i++){
        //    for(int j=1;j<=2*i;j++){
