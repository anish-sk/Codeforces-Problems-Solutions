...
int main()
{
    ...
    while(t--){
        ...
        ll ans = n + n - 1LL + max(n - 2LL,0LL) + max(n - 3LL, 0LL);
        int i = 0;
        while(i+2<n){
        ...
        i = 0;
        while(i+3<n){
            if(a[i] <= a[i+2] and a[i+2] <= a[i+3]) ans--;
            else if(a[i] >= a[i+2] and a[i+2] >= a[i+3]) ans--;
            else if(a[i] <= a[i+1] and a[i+1] <= a[i+3]) ans--;
            else if(a[i] >= a[i+1] and a[i+1] >= a[i+3]) ans--;
            else if(a[i] <= a[i+1] and a[i+1] <= a[i+2]) ans--;
            else if(a[i] >= a[i+1] and a[i+1] >= a[i+2]) ans--;
            else if(a[i+1] <= a[i+2] and a[i+2] <= a[i+3]) ans--;
            else if(a[i+1] >= a[i+2] and a[i+2] >= a[i+3]) ans--;
            i++;
        }
        cout<<ans<<"\n";
