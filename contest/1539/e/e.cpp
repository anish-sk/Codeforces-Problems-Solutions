...
signed main()
{
    ...
    for(int i=0; i<n; i++){
        ...
        while(sz(L) && ((*L.begin()).f < l2)) L.erase(*L.begin());                    
        while(sz(L) && ((*L.rbegin()).f > r2)) L.erase(*L.rbegin());                    
        while(sz(R) && ((*R.begin()).f < l)) R.erase(*R.begin());                    
        while(sz(R) && ((*R.rbegin()).f > r)) R.erase(*R.rbegin());                    
        prev = k;
        if(sz(L) == 0 && sz(R) == 0){
            cout<<"No\n";
            return 0;
